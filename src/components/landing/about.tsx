        ...
        <div id="about" className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
            <Balancer>
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        I have successfully built <span className="text-primary">complex web applications</span>, a <span className="text-primary">Python library that has over 500,000 downloads</span> and <span className="text-primary">a SaaS (Software as a Service) application</span>, including <Link className="text-primary hover:underline font-bold" target="_blank" href="https://blitzyapp.com/">BlitzyApp.com</Link>, <Link className="text-primary hover:underline font-bold" target="_blank" href="https://github.com/Hukasx0/ai-companion">AI-Companion</Link>, <Link className="text-primary hover:underline font-bold" target="_blank" href="https://pypi.org/project/aichar/">Aichar</Link>, and <Link className="text-primary hover:underline font-bold" target="_blank" href="https://github.com/Hukasx0/character-factory">Character Factory</Link>.
                    </p>
                    <p className="text-muted-foreground">
